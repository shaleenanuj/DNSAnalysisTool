...
<script type="text/javascript">
    ...
    function test() {
				...
				var y = new Date(document.getElementById("d1").value);
				var z = new Date(document.getElementById("d2").value);
...
<br>
<font color="red"><center>Enter Correct Values!!</center></font>
...
<div id="t3" > <input type="radio" name="basis2" id="basis2" value="Ips" >Source</div>
 ...
 <div id="t5" ><input type="radio" name="basis3" id="basis3" value="Ipd" onclick="check()" >For a particular host</div>
  ...
  Date <input type="date" name="date1" id="d1" required>   Start Time <input
			type="time" name="time1" id="t1" required> <br><br> <br>End Date <input
			type="date" name="date2" id="d2 " required> End Time <input
			type="time" name="time2" id="t2" required>
